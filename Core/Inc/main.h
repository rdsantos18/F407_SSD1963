...
#define TFT_D4_Pin GPIO_PIN_3
#define TFT_D4_GPIO_Port GPIOD
#define TFT_D5_Pin GPIO_PIN_4
#define TFT_D5_GPIO_Port GPIOD
#define TFT_D5D5_Pin GPIO_PIN_5
#define TFT_D5D5_GPIO_Port GPIOD
#define TFT_D6_Pin GPIO_PIN_6
#define TFT_D6_GPIO_Port GPIOD
#define TFT_D7_Pin GPIO_PIN_7
#define TFT_D7_GPIO_Port GPIOD
